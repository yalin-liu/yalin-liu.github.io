...
<div class="content-wrapper">
  ...
  <p>
      <span class="highlight">刘博士</span>作为项目负责人和联合负责人领导了总价值大约1,240万港元的项目，成功从香港RGC和HKMU研发部门获得了8项资助。她在顶尖期刊和会议上发表了一些论文，包括 IEEE Journal on Selected Areas in Communications（JCR Q1，影响因子：17.2）、IEEE Transactions on Vehicular Technology（JCR Q1，影响因子：7.1）、IEEE Network（JCR Q1，影响因子：6.3）、IEEE ICC（EI and CCF C conference）、 IEEE GLOBECOM（EI and CCF C conference）和 IEEE Wireless Communications Letters (JCR Q1，影响因子：5.5)。她的一篇论文「无人驾驶飞行器实现万物互联：机会与挑战」截至2025年8月19日在 Google Scholar 上的引用率高达280次。她于2025年获得了舒小佩慈善基金 - 杰出研究出版奖。她的发明「基于非侵入式学习者数据通过深度神经网络促进情感分类」在2022年iCAN大会上荣获金奖。
  </p>
  <p>
