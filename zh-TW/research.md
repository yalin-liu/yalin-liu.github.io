...
$(document).ready(function() {
  ...
  let publications = [
    ...
    { title: "針對夾持天線輔助隱蔽反向散射通訊的上行鏈路速率最大化", type: "journal", authors: "王玉磊, 劉亞林, 付雅茹, Yuanwei Liu", source: "IEEE Transactions on Vehicular Technology", year: "2026", link: "https://ieeexplore.ieee.org/document/11494673" },
    ...
    // conference
    { title: "Sky-Ear：一种基于無人機的受害者聲音偵測與定位系統", type: "conference", authors: "Yi Hong, Mingyang Wang, 劉亞林, 付雅茹, 熊景輝", source: "arXiv", year: "2026", link: "https://arxiv.org/pdf/2604.12455" },
