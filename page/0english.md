...
* Jiahui Feng, Yaru Fu, Zheng Shi, **Yalin Liu**, and Kevin Hung,  "Joint Optimization for Mobile Crowdsensing Systems With Reliability Consideration," *IEEE Transactions on Cognitive Communications and Networking (Early Access)*, pp. 1-1,  DOI: 10.1109/TCCN.2024.3504477， 24 November 2024. [[Link]](https://ieeexplore.ieee.org/abstract/document/10764779)

* **Yalin Liu**,  Hong-Ning Dai,  Qubeijian Wang,  Om Jee Pandey,  Yaru Fu,  Ning Zhang,  Dusit Niyato, and Chi Chung Lee,  "Space-Air-Ground Integrated Networks: Spherical Stochastic Geometry-Based Uplink Connectivity Analysis," *IEEE Journal on Selected Areas in Communications* **(SCI IF=16.4 in 2022, JCR Q1)**, vol. 42, no. 5, pp. 1387-1402, May 2024,  DOI: 10.1109/JSAC.2024.3365891. [[Link]](https://ieeexplore.ieee.org/document/10438999)
...
* **Yalin Liu**, Zhigang Yan, Bingyuan Luo, Xiaochi Xu, Hong-Ning Dai, Yaru Fu, Bishenghui Tao and Siu-Kei Au Yeung, "Hybrid Satellite-Ground Deployments for Web3 DID: System Design and Performance Analysis," accepted by *IEEE MetaCom 2025*, 3 July 2025. [[PDF]](https://arxiv.org/pdf/2507.02305)

* Yaru Fu, Yue Zhang, Zheng Shi, Yongna Guo and **Yalin Liu**, "Enhancing Mobile Crowdsensing Efficiency: A Coverage-aware Resource Allocation Approach," accepted by *IEEE Vehicular Technology Conference (VTC)*, 27 March 2025, DOI: 10.48550/arXiv.2503.21942 [[PDF]](https://arxiv.org/pdf/2503.21942)

* Yulei Wang, **Yalin Liu**, Yaru Fu, Yujie Qin, and Zhontgjie Li, "3D Stochastic Geometry Model for Aerial Vehicle-Relayed Ground-Air-Satellite Connectivity," accepted by *IEEE 101st Vehicular Technology Conference (VTC2025-Spring)*, 20 March 2025. [[PDF]](https://arxiv.org/abs/2503.16202)

* **Yalin Liu**,  Yaru Fu,  Qubeijian Wang, and Hong-Ning Dai,  "Unified Network Modeling for Six Cross-Layer Scenarios in Space-Air-Ground Integrated Networks," accepted by *IEEE International Conference on Communications (ICC)* **(EI and CCF C conference)**, 30 April 2025. [[PDF]](https://arxiv.org/abs/2504.21284)
