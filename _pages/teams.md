    ...
    <div class="container-team">
        ...
        <div class="team-container">
            <div class="member-card">
                ...
                <p class="member-period">Jul 2024 - Dec 2024</p>
                <div class="member-bio-badges">
            ...
            <div class="member-card">
                ...
                <h3>Dr. WEN XITING</h3>
                <!-- <p class="role">Postdoc</p> -->
                <p class="member-period">Feb 2025 - Dec 2025</p>
                <div class="member-bio-badges">
        ...
        <div class="team-container">
            <div class="member-card">
                ...
                <p class="member-period">Mar 2025 – Apr 2026</p>
                <div class="member-bio-badges">
            ...
            <div class="member-card">
                ...
                <!-- <p class="role">Research Assistant</p> -->
                <p class="member-period">Mar 2025 – Present</p>
                <div class="member-bio-badges">
            ...
            <div class="member-card">
                ...
                <h3>Mr. FU YUHAO</h3>
                <p class="role">Research Assistant</p>
                <p class="member-period">Jul 2025 – Sep 2025</p>
                <div class="member-bio-badges">
            ...
            <div class="member-card">
                ...
                <h3>Ms. DENG QI</h3>
                <!-- <p class="role">Research Assistant</p> -->
                <p class="member-period">Jul 2025 – Present</p>
                <div class="member-bio-badges">
            ...
            <div class="member-card">
                ...
                <!-- <p class="role">Research Assistant</p> -->
                <p class="member-period">Oct 2024 — Mar 2025</p>
                <div class="member-bio-badges">
            ...
            <div class="member-card">
                <div class="member-photo">
                    <img src="{{ site.baseurl }}/assets/images/yi_hong.jpg" alt="Mr.YI HONG">
                </div>
                <h3>Mr. YI HONG</h3>
                <!-- <p class="role">Research Assistant</p> -->
                <p class="member-period">Feb 2026 - present</p>
                <div class="member-bio-badges">
        ...
        <div class="team-container">
            <div class="member-card">
                ...
                <!-- <p class="role">MPhil Student</p> -->
                <p class="member-period">Jan 2026 - present</p>
                <div class="member-bio-badges">
                    <span class="badge text-bg-secondary">Federated Learning</span>
                    <span class="badge text-bg-secondary">Edge Intelligence</span>
                    <span class="badge text-bg-secondary">AI for Healthcare</span>
