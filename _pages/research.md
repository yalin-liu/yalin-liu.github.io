...
$(document).ready(function() {
  ...
  let publications = [
    ...
    { title: "Uplink Rate Maximization for Pinching Antenna- Assisted Covert Backscatter Communication", type: "journal", authors: "Yulei Wang, Yalin Liu, Yaru Fu, Yuanwei Liu", source: "IEEE Transactions on Vehicular Technology", year: "2026", link: "https://ieeexplore.ieee.org/document/11494673" },
    ...
    // Conference
    { title: "Sky-Ear: An Unmanned Aerial Vehicle-Enabled Victim Sound Detection and Localization System,", type: "conference", authors: "Yi Hong, Mingyang Wang, Yalin Liu, Yaru Fu, Kevin Hung", source: "arXiv", year: "2026", link: "https://arxiv.org/pdf/2604.12455" },
    { title: "Deception Against Reactive Jammer: Deep Reinforcement Learning for Adaptive Anti-Jamming (accepted)", type: "conference", authors: "Xintai Cao, Qubeijian Wang, Xiuping Li, Wen Sun, Yalin Liu", source: "IEEE International Conference on Communications (ICC) (EI and CCF C conference)", year: "2026", link: "#" },
    { title: "Multi-Waveguide Pinching Antenna Placement Optimization for Rate Maximization (accepted)", type: "conference", authors: "Yue Zhang, Yaru Fu, Pei Liu, Yalin Liu, Kevin Hung", source: "IEEE International Conference on Communications (ICC) (EI and CCF C conference)", year: "2026", link: "https://arxiv.org/abs/2512.18711" },
